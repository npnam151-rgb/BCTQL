    ...
    return (
      ...
      >
        ...
        <div className="text-center mb-8 border-b-2 border-slate-800 pb-6 relative">
          <h1 className="text-2xl font-bold uppercase tracking-wide text-slate-900 mb-4">
            Báo Cáo TQL
          </h1>
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 text-base font-medium text-slate-700">
            <div>
              Ngày: <span className="font-bold text-slate-900">{data.date ? format(new Date(data.date), 'dd/MM/yyyy') : '...'}</span>
            </div>
            <div>
              Người báo cáo: <span className="font-bold text-slate-900">{data.reporter || '...'}</span>
            </div>
            <div>
